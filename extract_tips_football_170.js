        ...
        for (let i = 0; i < competitions.length; i++) {
            ...
            if (tip == "1" || tip == "1X" || tip == "2" || tip == "X2" || tip == "12") {
                ...
                if (tipTeam1 >= 59 || tipTeam2 >= 59) {
                    ...
                    const betTeam1 = parseFloat(infoBet[0].children[0].children[1].children[0].children[0].data);
                    const betTeam2 = parseFloat(infoBet[0].children[0].children[3].children[0].children[0].data);

                    n++;

                    if (betTeam1 >= 1.50 && betTeam1 <= 1.70) {
                        percentTip = tipTeam1;
                        percentages.push(tipTeam1)
                    } else if (betTeam2 >= 1.50 && betTeam2 <= 1.70) {
                        percentTip = tipTeam2;
