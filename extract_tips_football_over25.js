...
const scrapeData = async () => {
    ...
    if (competitions.length > 0) {
        ...
        for (let i = 0; i < competitions.length; i++) {
            ...
            const tipOver25 = parseInt(competitions[i].children[3].children[0].children[8].children[0].children[0]
                .data);
            ...
            if (tipOver25 >= 68) {
                ...
                percentTip = tipOver25;
                percentages.push(tipOver25)
                ...
                let resultTip = "NA";
                if (!isNaN(totalGoals) && totalGoals > 2) {
                    resultTip = "YES";
                    countTypeResult.yes += 1;
                } else if (!isNaN(totalGoals) && totalGoals < 3) {
                    resultTip = "NO";
